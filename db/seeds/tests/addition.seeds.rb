...
addition = Test.create(name: "Addition 1-16", len: 61, time: 90, construct: "Sarahs Tests", subject: "Mathematik", archive: false,
...
while i < all_items.length do
	it = addition.items.build(itemtext: all_items[i].join(','), itemview: 'items/studentbased/additiontest/2testItemAddition', itemtype: 0, shorthand: all_items[i].join(','),
